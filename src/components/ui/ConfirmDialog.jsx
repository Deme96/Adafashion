    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 modal-overlay">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl modal-content p-6">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-2">{title || 'Confirmar'}</h3>
          <p className="text-sm text-gray-500 mb-6">{message || 'Tem certeza que deseja realizar esta ação?'}</p>
